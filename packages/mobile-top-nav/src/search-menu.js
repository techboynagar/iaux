...
class SearchMenu extends LitElement {
  ...
  searchTypeSelected(e) {
    ...
    console.log('searchTypeChosen: ', searchType);
  ...
  get searchTypesTemplate() {
    const searchTypes = [
      ...
      const input = checked
        ? html`<input type="radio" name="search" value="${option}" checked="" @click="${this.searchTypeSelected}"/>`
        : html`<input type="radio" name="search" value="${option}" @click="${this.searchTypeSelected}"/>`;
